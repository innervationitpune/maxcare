...
import { Phone, PoundSterling, Clock, AlertTriangle } from 'lucide-react';
...
const Services = () => {
  const treatments = [
    ...
    'Injections for Headaches', // ✅ updated (was Botox Injection)
              ...
              {treatments.map((treatment, index) => (
                ...
                >
                  <div className="flex items-center">
                    <div className="w-3 h-3 bg-[#567c8d] rounded-full mr-3" />
            ...
            <div>
              ...
              <div className="space-y-4">
                {feeStructure.map((item, index) => (
                  <div
                    key={index}
                    className="flex justify-between items-center p-4 bg-[#F5EFEB] rounded-lg shadow-sm"
                  >
                    <div>
                      <h4 className="font-medium text-[#567c8d]">{item.service}</h4>
                      <p className="text-sm text-[#567c8d]">{item.duration}</p>
                    </div>
                    <span className="text-base sm:text-lg font-bold text-[#567c8d]">
                      {item.price}
                    </span>
                  </div>
                ))}
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3 p-4 bg-[#F5EFEB] rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#567c8d] mt-1">
                      Appointments cancelled with less than 24 hours notice will incur the full cost
                      of the appointment. This appointment and the fee paid do not include treatment
                      or investigations.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 p-4 bg-[#F5EFEB] rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#567c8d] mt-1">
                      Insured patients should contact their insurer directly and liaise with
                      secretary Ms Pizzey.
                    </p>
                  </div>
                </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700 mt-1">
                  Fees may vary based on procedure complexity and individual needs. A detailed quote
                  will be provided during your consultation. Contact us for specific pricing on
